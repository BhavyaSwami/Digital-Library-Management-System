    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/users/**").permitAll() // Temporarily allow all user endpoints
                .requestMatchers("/api/borrowings/**").permitAll() // Temporarily allow all borrowing endpoints
